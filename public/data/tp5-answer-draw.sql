...
-- Records of ob_admin
-- ----------------------------
INSERT INTO `ob_admin` VALUES ('1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '1587448830', '127.0.0.1', '25', '0', '1587448830');
...
CREATE TABLE `ob_auth_rule` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='权限规则';
...
CREATE TABLE `ob_topic` (
  ...
  `choose_id` int(11) DEFAULT NULL COMMENT '选项表的id',
  `topic_correct` varchar(255) DEFAULT NULL COMMENT '选项正确答案（id?)',
  `add_time` bigint(20) DEFAULT NULL COMMENT '增加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='题表';
